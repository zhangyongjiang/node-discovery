...
func verifyECDSA(k *ecdsa.PublicKey, signature, digest []byte, opts SignerOpts) (valid bool, err error) {
...
func (v *EcdsaPrivateKeyVerifier) Verify(k Key, signature, digest []byte, opts SignerOpts) (valid bool, err error) {
	return verifyECDSA(&(k.(*ecdsaPrivateKey).privKey.PublicKey), signature, digest, opts)
}

type EcdsaPublicKeyKeyVerifier struct{}

func (v *EcdsaPublicKeyKeyVerifier) Verify(k Key, signature, digest []byte, opts SignerOpts) (valid bool, err error) {
